...
export const WithSizes: Story = {
  render: () => (
    <BadgeList>
      <BadgeListItem size="small" color="gray">Small</BadgeListItem>
      <BadgeListItem size="normal" color="blue">Normal</BadgeListItem>
      <BadgeListItem size="large" color="orange">Large</BadgeListItem>
    </BadgeList>
  ),
  args: {} as any,
};
