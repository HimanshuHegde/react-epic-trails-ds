...
const Wizard: React.FC<WizardProps> = ({
    ...
    return (
        ...
        >
            <WizardContent id={id}>{children}</WizardContent>
        </WizardContextProvider>
    );
};
...
): element is React.ReactElement<WizardStepProps> => {
...
const WizardContent: React.FC<WizardContentProps> = ({ id, children }) => {
    ...
    const { activeStep, completedSteps, goToStep, totalSteps, setTotalSteps } =
        useWizard();
